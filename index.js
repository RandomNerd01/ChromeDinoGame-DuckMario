...
(function () {
    ...
    if (boxCompare(tRexBox, obstacleBox, obstacle, tRex)) {
        ...
        for (var t = 0; t < tRexCollisionBoxes.length; t++) {
            for (var i = 0; i < collisionBoxes.length; i++) {
                ...
                if (boxCompare(adjTrexBox, adjObstacleBox, obstacle , tRex)) {
...
let canDecrement= true;
    ...
    function boxCompare(tRexBox, obstacleBox, obstacle, tRex) {
	...
	if (obstacle && obstacle.typeConfig && obstacle.typeConfig.type != 'STAR1'&& obstacle.typeConfig.type != 'MUSHROOM' && currentTime!=undefined && Date.now() > currentTime + 4000) {
	...
	if (obstacle && obstacle.typeConfig && obstacle.typeConfig.type === 'MUSHROOM'&&window.lives<23) {
	    window.lives=23;
	    if(window.displaylives==1 ){
        	    window.displaylives=2;
        	    }
	    updateLivesDisplay();
	    console.log(window.lives);
	    playAudioForDuration('https://randomnerd01.github.io/ChromeDinoGame-DuckMario/output1.mp3', 750, 0);
}
	    ...
	    var currentspeed= Runner.instance_.currentSpeed;
            ...
            // Increase speed
             Runner.instance_.setSpeed(currentspeed * 1.01); // Example: double the speed

            // Restore original speed after 4 seconds
            setTimeout(function() {
                Runner.instance_.setSpeed(originalJumpVelocity);
            }, 4000); // 4 seconds
	    // Play audio for 4 seconds
            playAudioForDuration('https://randomnerd01.github.io/ChromeDinoGame-DuckMario/output.mp3', 4000, 8);
        ...
        },
{
        ...
        },
        {
            ...
            minSpeed: 0,
            collisionBoxes: [
                new CollisionBox(0, 12, 4, 38),
                new CollisionBox(8, 0, 4, 49),
                new CollisionBox(13, 10, 6, 38)
            ]
        },
        {
            type: 'PTERODACTYL',
...
function updateLivesDisplay() {
    ...
    livesDisplay.textContent = "Lives: " + window.displaylives;
}

// Simulate changing lives over time
setInterval(() => {
    updateLivesDisplay();
